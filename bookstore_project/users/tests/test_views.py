...
from bookstore_project.users.models import User
from bookstore_project.users.tests.factories import UserFactory
from bookstore_project.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
